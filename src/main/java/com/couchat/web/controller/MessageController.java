...
public class MessageController {
     ...
     */
    @PostMapping
    public ResponseEntity<Message> sendMessage(@RequestBody Message clientMessageDto) {
        ...
        // Reconstruct the message on the server-side to ensure integrity of senderId, messageId, timestamp
        // The clientMessageDto acts as a data transfer object for payload, recipient, type, etc.
        Message newMessage = new Message(
                clientMessageDto.getConversationId(), // Client must provide conversationId
                clientMessageDto.getType(),
                senderId, // Overridden by authenticated user
                clientMessageDto.getRecipientId(),
                clientMessageDto.getPayload()
        );
        if (clientMessageDto.getOriginalMessageId() != null) {
            newMessage.setOriginalMessageId(clientMessageDto.getOriginalMessageId());
        }
        // newMessage.setStatus(Message.MessageStatus.PENDING); // Constructor sets this
